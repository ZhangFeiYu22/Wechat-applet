<template>
  <div class="consultDetails">
    ...
    <div class="head" @click.stop="goPersonal(solicitDetails.createId)">
      <div class="headImg">
        <img
          v-if="solicitDetails.avatar"
          :src="solicitDetails.avatar"
          mode="aspectFill"
        />
      </div>
      <div class="headName">
        ...
        <p class="phone">
          ...
          <i
            ...
            v-else-if="solicitDetails.gender == 2"
          ></i>
    ...
    <div class="taskBox">
      ...
      <div class="line">
        <p class="pl">实名:</p>
        <p class="pr">
          {{ solicitDetails.needReal == "1" ? "需要" : "不需要" }}
        </p>
      </div>
    ...
    <div class="detailsBox">
      ...
      <div class="detail-imgList">
        <div
          class="imgbox"
          v-for="(item, index) in solicitDetails.images"
          :key="index"
        >
    ...
    <div class="joinDialog" v-if="joinMask">
      ...
      <div class="joinContent">
        ...
        <div class="line" v-if="solicitDetails.needPic == '1'">
          <p class="pl">认证图片:</p>
          <div class="edit-img">
            ...
            <div
              ...
              @click.stop="chooseImageOne"
            ></div>
          </div>
        </div>
        <div class="btnG">
          <div class="btn cancl" @click.stop="closeJoinMask">取消</div>
          <div class="btn sure" @click.stop="sureJoin(solicitDetails)">
            确认参加
          </div>
        </div>
      </div>
